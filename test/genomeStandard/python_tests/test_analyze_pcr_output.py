...
class TestAnalyzePcrOutput(unittest.TestCase):
    ...
    """
    def setUp(self):
        self.pcr_file = './data/pcr_output.fa'
        self.primer_file = './data/total_primers.csv'
        ...
        self.filtered = ap.filter_merged(self.merged_df)
    ...
    def test_filter_merged(self):
        ...
        """
        self.assertEqual(len(ap.filter_merged(self.merged_df)), 1)
