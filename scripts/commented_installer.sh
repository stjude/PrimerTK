...
PrimerTK does not serve to distribute primer3 or any of its components. By uncommenting, you, the user, agree to the
terms and conditions of the GPL2 license and are agreeing to download primer3 independently of PrimerTK.

In Silico PCR [isPCR] is freely available for non-profit/educational use only without a license. 
By uncommenting you are agreeing that you are a non-profit/educational institution and do not intend to use this
